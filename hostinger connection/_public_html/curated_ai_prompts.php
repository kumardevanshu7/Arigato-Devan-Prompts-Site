...
$cat_meta = [
    'all' => [
        ...
        'hero' => 'Curated AI',
        'tagline' => 'Carefully refined and enhanced AI prompts, inspired by various creative sources and transformed for better results, creativity, and ease of use.',
        'icon' => 'fa-ban',
        'theme_color' => '#2F4156',
        'count_label' => 'Total prompts',
    ],
    'boys' => [
        'title' => 'Boys Prompts — Curated AI Prompts',
        'hero' => 'Boys',
    ...
    'girls' => [
        'title' => 'Girls Prompts — Curated AI Prompts',
        'hero' => 'Girls',
    ...
    'couple' => [
        'title' => 'Couple Prompts — Curated AI Prompts',
        'hero' => 'Couple',
...
/* ── Category hub — icon rail (no cards) ── */
.nm-cat-hub { max-width: 720px; margin: 0 auto; padding: 4px clamp(16px, 4vw, 28px) 28px; width: 100%; }
.nm-cat-hub-title {
    text-align: center;
    font-size: .68rem;
    font-weight: 800;
...
.nm-cat-card:hover { transform: translateY(-2px); }
.nm-cat-card:focus-visible {
...
.nm-cat-card-name { font-size: .78rem; font-weight: 800; letter-spacing: -.01em; line-height: 1.2; }
.nm-cat-card-count { font-size: .64rem; font-weight: 650; color: var(--pal-teal); }
...
@media (max-width: 520px) {
    .nm-cat-card { width: 72px; }
    .nm-cat-card-icon { width: 50px; height: 50px; font-size: .95rem; }
}
