...
<meta property="og:title" content="Blogs ó Arigato Devan Prompts">
...
<meta name="twitter:title" content="Blogs ó Arigato Devan Prompts">
...
<style>
/* &mdash;&ndash;ù&mdash;&ndash;ù&mdash; Blogs Page &mdash;&ndash;ù&mdash;&ndash;ù&mdash; */
.blogs-hero {
...
/* &mdash;&ndash;ù&mdash;&ndash;ù&mdash; Tag Filter Pills &mdash;&ndash;ù&mdash;&ndash;ù&mdash; */
.tag-filter-wrap {
    max-width: 1300px;
    margin: 0 auto 40px;
    padding: 0 40px;
...
/* &mdash;&mdash;&mdash;&mdash;&mdash; Normal Grid ó Pinterest Masonry &mdash;&mdash;&mdash;&mdash;&mdash; */
.blogs-grid {
    column-count: 5;
    column-gap: 18px;
    margin-top: 20px;
...
<div class="blogs-wrap">
  ...
  <div id="no-results-msg" style="display:none;text-align:center;padding:60px 20px;color:#7D7887;font-weight:700;font-size:1.1rem;">
    No blogs found for this tag <i class="fa-solid fa-magnifying-glass"></i>ç
  </div>
