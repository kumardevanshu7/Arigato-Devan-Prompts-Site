...
<div class="drawer" id="sideDrawer">
    ...
    <nav class="drawer-nav">
        ...
        <a href="feedback_admin.php" class="d-link active"><i class="fa-solid fa-comments" style="color:#fb923c;"></i> <span style="color:#fb923c; font-weight:700;">Feedback Manager</span></a>
...
<div class="mob-topbar">
    ...
    <div class="mob-page-title"><i class="fa-solid fa-comments" style="-webkit-text-fill-color:var(--accent2);margin-right:6px"></i>Feedback Manager</div>
...
<aside class="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="feedback_admin.php" class="sb-link active"><i class="fa-solid fa-comments" style="color:#fb923c;"></i> <span style="color:#fb923c; font-weight:700;">Feedback Manager</span></a>
