        ...
        <aside class="be-panel">
            ...
            <div>
                ...
                <div class="be-form-group" style="margin-bottom: 8px;">
                    ...
                    <input type="text" class="be-form-input" id="seo-focus-keyword" name="focus_keyword" value="<?= htmlspecialchars($bl["focus_keyword"] ?? "") ?>" placeholder="e.g. couple prompt, gemini nano banana..." autocomplete="off">
                </div>
...
function openLivePreview() {
    ...
    var coverPortrait = (imgP && imgP.style.display !== 'none' && imgP.src) ? imgP.src : '<?= addslashes($bl["image_path"] ?? "") ?>';
    var imgL = document.getElementById('coverPreviewLand');
    var coverLand = (imgL && imgL.style.display !== 'none' && imgL.src) ? imgL.src : '<?= addslashes($bl["image_path_landscape"] ?? "") ?>';
    ...
    addField('preview_id', '<?= (int)($bl["id"] ?? 0) ?>');
