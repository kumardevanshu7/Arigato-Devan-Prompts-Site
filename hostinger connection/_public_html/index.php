        ...
        <div class="landing-center">
            ...
            <div id="hero-comic-note" style="position:relative;margin:18px auto 18px;max-width:460px;background:#fffbe6;border:3px solid var(--text-color,#2d2a35);border-radius:18px;padding:16px 22px 16px;box-shadow:4px 4px 0 var(--text-color,#2d2a35);text-align:center;">
                ...
                <div style="margin-top:14px;display:flex;align-items:center;justify-content:center;gap:8px;">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--text-color,#2d2a35)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="animation:heroNoteArrow 1.1s ease-in-out infinite;"><line x1="12" y1="3" x2="12" y2="21"/><polyline points="6 15 12 21 18 15"/></svg>
            ...
            (function(){
                var msgs = [
                    'No need to login &mdash; you can copy any prompt for free! Just click <strong>Explore</strong>. Login is only for liking &amp; saving prompts &#128522;',
                    'Login ki zaroorat nahi &mdash; bina login ke bhi koi bhi prompt copy kar sakte ho! Bas <strong>Explore</strong> click karo. Login sirf like &amp; save ke liye hai &#128516;'
                ];
                var i = 0;
