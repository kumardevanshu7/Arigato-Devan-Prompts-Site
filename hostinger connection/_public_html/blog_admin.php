...
<div class="drawer" id="sideDrawer">
  ...
  <nav class="drawer-nav">
    ...
    <a href="blog_admin.php" class="d-link active"><i class="fa-solid fa-pen-nib" style="color:#38bdf8;"></i> <span style="color:#38bdf8; font-weight:700;">Blog Admin</span></a>
    ...
    <a href="curated_admin.php" class="d-link nm-dash-brand"><i class="fa-solid fa-upload" style="color:#e879f9;"></i> <span style="color:#e879f9; font-weight:700;">Curated — Upload</span></a>
    <a href="curated_manage.php" class="d-link nm-dash-brand"><i class="fa-solid fa-table-list" style="color:#e879f9;"></i> <span style="color:#e879f9; font-weight:700;">Curated — Manage</span></a>
    <a href="curated_links.php" class="d-link nm-dash-brand"><i class="fa-solid fa-link" style="color:#e879f9;"></i> <span style="color:#e879f9; font-weight:700;">Curated — Links</span></a>
...
<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a href="blog_admin.php" class="sb-link active"><i class="fa-solid fa-pen-nib" style="color:#38bdf8;"></i> <span style="color:#38bdf8; font-weight:700;">Blog Admin</span></a>
...
<div class="main">
  ...
  <div class="topbar">
    ...
    <a href="blog_create.php" class="tb-btn tb-purple"><i class="fa-solid fa-plus" style="color:#38bdf8;"></i> <span style="color:#38bdf8; font-weight:700;">New Post</span></a>
  </div>
